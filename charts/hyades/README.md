...
![Version: 0.25.0](https://img.shields.io/badge/Version-0.25.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 5.0.3](https://img.shields.io/badge/AppVersion-5.0.3-informational?style=flat-square)

DEPRECATED: hyades was the preview chart for Dependency-Track v5.
It is discontinued in favor of version 2 of the `dependency-track` chart.

Migration guide:
https://github.com/DependencyTrack/helm-charts/blob/main/charts/dependency-track/UPGRADING.md
