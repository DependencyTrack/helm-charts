...
![Version: 0.14.0](https://img.shields.io/badge/Version-0.14.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.7.0-alpha.4](https://img.shields.io/badge/AppVersion-0.7.0--alpha.4-informational?style=flat-square)
...
| apiServer.image.tag | string | `"5.7.0-alpha.4"` | Can be a tag name such as "latest", or an image digest prefixed with "sha256:". |
...
| frontend.image.tag | string | `"5.7.0-alpha.4"` | Can be a tag name such as "latest", or an image digest prefixed with "sha256:". |
...
| initializer.image.tag | string | `"5.7.0-alpha.4"` | Can be a tag name such as "latest", or an image digest prefixed with "sha256:". |
